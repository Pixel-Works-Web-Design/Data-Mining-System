 ...
 // Insert Record
  if(isset($_REQUEST['save']))
  {
      ...
      */
        ...
        $done = mysql_query("UPDATE privacypolicy set policy_description = '$pagecontent'  where policy_id  = '1'");
        if($done)
        {
           echo "<script type='text/javascript'>window.location='Privacy_Policy.php?s='</script>";
        }
        else{
          echo "<script type='text/javascript'>window.location='Privacy_Policy.php?f='</script>";
        }
...
<div class="container">
  ...
  <div class="content">
    ...
    <div class="content-header">
        <h2 class="content-header-title">Privacy Policy </h2>
        <ol class="breadcrumb">
          <li><a href="dashboard.php">Home</a></li>
          <li class="active"><a href="javascript:;">Privacy Policy </a></li>
    ...
    <?php
       include("conn.inc.php");
    $get = mysql_query("SELECT * from privacypolicy where policy_id = '1'");
...
<div class="portlet-header">
        ...
        <div class="portlet-content">
          ...
          <form method="post" id="validate-basic" action="Privacy_Policy.php" class="form parsley-form" data-validate="parsley" enctype="multipart/form-data"> 
       <?php if(isset($_REQUEST['s'])) {?>
      <div class="alert alert-success">
        <a class="close" data-dismiss="alert" href="#" aria-hidden="true">×</a>
        <strong>Succesfully!</strong> updated Privacy Policy  !.
      </div>
      ...
      <?php } else if(isset($_REQUEST['f'])) {?>
       ...
       <div class="alert alert-danger">
        <a class="close" data-dismiss="alert" href="#" aria-hidden="true">×</a>
        <strong>Error!</strong> Privacy Policy  Not Updated !.
      </div>
      <?php } else{ ?>
...
<div class="col-sm-12"><br></div>
   ...
   <div class="col-sm-12">
       <div class="form-group">
        ...
        <?php echo $data['policy_description']; ?>
             </textarea>
            </div>
        </div>
  </div>
