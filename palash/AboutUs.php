 ...
 // Insert Record
  if(isset($_REQUEST['validate']))
  {
       ...
       include("conn.inc.php");
        ...
        mysql_query("INSERT into aboutus(about_title , about_content) values('$pagetitle' , '$pagecontent')");
      ...
      if(!empty($_FILES['file1']['name']))
      {
          ...
          if($filename1[1]=="gif" || $filename1[1]=="jpeg" || $filename1[1]=="jpg"|| $filename1[1]=="png" || $filename1[1]=="bmp" || $filename1[1]=="GIF" || $filename1[1]=="JPEG" || $filename1[1]=="JPG"|| $filename1[1]=="PNG" || $filename1[1]=="BMP" )
            ...
            $photoname = date("dmYs").$pname; 
             ...
             mysql_query("UPDATE aboutus set about_img = '$photoname'  where about_id  = '$last_id'");
      ...
      if(!empty($_FILES['file_bread']['name']))
      {
          ...
          if($filename1[1]=="gif" || $filename1[1]=="jpeg" || $filename1[1]=="jpg"|| $filename1[1]=="png" || $filename1[1]=="bmp" || $filename1[1]=="GIF" || $filename1[1]=="JPEG" || $filename1[1]=="JPG"|| $filename1[1]=="PNG" || $filename1[1]=="BMP" )
            ...
            $Breadname = date("dmYs").$Bname; 
             ...
             mysql_query("UPDATE aboutus set about_breadcrumb = '$Breadname'  where about_id  = '$last_id'");
  ...
  if(isset($_REQUEST['update_category']))
  {
      ...
      mysql_query("UPDATE aboutus set about_title = '$pagetitle' , about_content = '$pagecontent' where about_id = '$id'");
      ...
      if(!empty($_FILES['file1']['name']))
      {
        ...
        if($filename1[1]=="gif" || $filename1[1]=="jpeg" || $filename1[1]=="jpg"|| $filename1[1]=="png" || $filename1[1]=="bmp" || $filename1[1]=="GIF" || $filename1[1]=="JPEG" || $filename1[1]=="JPG"|| $filename1[1]=="PNG" || $filename1[1]=="BMP" )
        {
            ...
            move_uploaded_file($_FILES['file1']['tmp_name'],"photos/".$photonew);
             ...
             mysql_query("UPDATE aboutus set about_img = '$photonew' where about_id = '$id'");
          ...
          if($filename1[1]=="gif" || $filename1[1]=="jpeg" || $filename1[1]=="jpg"|| $filename1[1]=="png" || $filename1[1]=="bmp" || $filename1[1]=="GIF" || $filename1[1]=="JPEG" || $filename1[1]=="JPG"|| $filename1[1]=="PNG" || $filename1[1]=="BMP" )
            {
              ...
              $Breadname = date("dmYs").$Bname; 
               move_uploaded_file($_FILES['file_bread']['tmp_name'],"photos/".$Breadname); 
               mysql_query("UPDATE aboutus set about_breadcrumb = '$Breadname'  where about_id  = '$id'");
...
<!--<div class="container">
  ...
  if(isset($_REQUEST['remove']))
  {
     ...
     $id = $_REQUEST['id'];
     $imgname = $_REQUEST['img'];
     $check = mysql_query("DELETE  from aboutus where about_id = '$id'");
    ...
    if($check)
    {
       if(!($imgname == NULL || $imgname == ''))
      {
       ...
       echo "<script type='text/javascript'>alert('Unable to Remove this About Us Page!');</script>";
      echo "<script type='text/javascript'>window.location='AboutUs.php'</script>";
    }
  } // End of Create
...
<div class="portlet-header">
        ...
        <div class="portlet-content">
          <form method="post" id="validate-basic" action="AboutUs.php" class="form parsley-form" data-validate="parsley" enctype="multipart/form-data"> 
...
<div class="col-sm-12">
       <div class="form-group">
           ...
           <label class="col-md-3">Page Title :<strong style="color:Red">*</strong></label>
            <div class="col-md-7">
...
<div class="col-sm-12"><br><br></div>
  ...
  else if(isset($_REQUEST['update']))
  {
      include("conn.inc.php");
      $id = $_REQUEST['id'];
      $get = mysql_query("SELECT * from aboutus where about_id = '$id'");
 ...
 <div class="col-sm-12">
       <div class="form-group">
           ...
           <label class="col-md-3">
            ...
            <!-- Image -->
            <?php 
            if(!($data['about_breadcrumb'] == NULL || $data['about_breadcrumb'] == ''))
            {
            ?>
              <div class="col-sm-2">
               <div class="thumbnail-view">
               <a class="thumbnail-view-hover ui-lightbox" href="photos/<?php echo $data['about_breadcrumb']; ?>">
                        </a>
                <img src="photos/<?php echo $data['about_breadcrumb']; ?>" width="70" alt="Image">
                </div>
               </div>
            <?php
            }
...
<div class="col-sm-12">
       <div class="form-group">
           ...
           <label class="col-md-3">Page Title :<strong style="color:Red">*</strong></label>
            <div class="col-md-7">
              <input name="title" type="text" id="title" tabindex="2" class="form-control" data-required="true"  value="<?php echo $data['about_title'] ?>"/>
            </div>
        </div>
  </div>
       ...
       <div class="form-group">
           ...
           <label class="col-md-3">Image :<strong style="color:Red">*</strong></label>
            <div class="col-md-7">
              ...
              <div class="col-sm-2">
             <div class="thumbnail-view">
             <a class="thumbnail-view-hover ui-lightbox" href="photos/<?php echo $data['about_img']; ?>">
                      </a>
              <img src="photos/<?php echo $data['about_img']; ?>" width="70" alt="Image">
              </div>
          </div>
         ...
         <div class="portlet">
              ...
              <h3>
               ...
               About Us&nbsp;&nbsp;
                ...
                <a href="AboutUs.php?create=y"><i class="fa fa-plus-square"></i></a>
              ...
              >
                  ...
                  <tbody>
                     <?php
         include("conn.inc.php");
               $get = mysql_query("SELECT *from aboutus");
               $i = 1;
               while($row = mysql_fetch_array($get))
               {
                ?>
                    ...
                    <td style="text-align: center;">
                      <div class="thumbnail-view">
                      <a class="thumbnail-view-hover ui-lightbox" href="photos/<?php echo $row['about_img']; ?>">
                      </a>

                       <img src="photos/<?php echo $row['about_img']; ?>" width="60" alt="Image" style="width: 170px; height: 70px;">
                    </div>
                    </td>
                    <td><a href="AboutUs.php?update=y&id=<?php echo $row['about_id']; ?>&img=<?php echo $row['about_img']; ?>"><button class="btn btn-secondary" type="button">Update</button></a></td>
                        
                      <td>
                        <a href="AboutUs.php?remove=y&id=<?php echo $row['about_id']; ?>&img=<?php echo $row['about_img']; ?>" onclick="return confirm('Are you sure you have to Remove this About Us Page  ??')"><button class="btn btn-primary">Delete</button></a>
                    </td>
                    </tr>
